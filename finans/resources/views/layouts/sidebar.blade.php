...
<nav class="sidebar-nav">
    <ul class="nav in side-menu">
        ...
        @if(\App\Models\UserPermissions::getMyControl(0))
        <li class="menu-item-has-children">
            ...
            <ul class="list-unstyled sub-menu">
                <li>
                    <a href="{{route('customer.index')}}">Müşteri Listesi</a>
                </li>
                <li>
                    <a href="{{route('customer.create')}}">Yeni Müşteri Ekle</a>
                </li>

            </ul>
        </li>
        @endif
         @if(\App\Models\UserPermissions::getMyControl(1))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
        ...
        @endif
        @if(\App\Models\UserPermissions::getMyControl(2))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
            ...
            <ul class="list-unstyled sub-menu">
                ...
                <li>
                    <a href="{{route('fatura.create',FATURA_GELIR)}}">Yeni Gelir Faturası Ekle</a>

                </li>

                <li>
                    <a href="{{route('fatura.create',FATURA_GIDER)}}">Yeni Gider &Faturası Ekle</a>
        ...
        @endif
        @if(\App\Models\UserPermissions::getMyControl(3))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
                <i class="list-icon feather feather-user"></i> <span class="hide-menu">Ürün</span>
            </a>
            <ul class="list-unstyled sub-menu">
                <li>
        ...
        @endif
        @if(\App\Models\UserPermissions::getMyControl(4))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
        ...
        @endif
        @if(\App\Models\UserPermissions::getMyControl(5))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
        ...
        @endif
        @if(\App\Models\UserPermissions::getMyControl(6))
        <li class="menu-item-has-children">
            <a href="javascript:void(0);">
