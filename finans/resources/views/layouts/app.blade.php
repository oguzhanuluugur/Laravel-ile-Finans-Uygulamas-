                ...
                <div
                    ...
                    <div class="card">
                        ...
                        <ul class="list-unstyled card-body">
                            ...
                            <li><a href="{{route('logout')}}"onclick="event.preventDefault();document.getElementById('logout-form').submit();"><span><span class="align-middle">ÇIKIŞ</span></span></a>
        ...
        <ul class="nav navbar-nav d-none d-lg-flex ml-2 ml-0-rtl">
            <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle ripple" data-toggle="dropdown"><i class="feather feather-hash list-icon"></i></a>
                <div class="dropdown-menu dropdown-left dropdown-card animated flipInY">
                    <div class="card">
                        <header class="card-header d-flex align-items-center mb-0"><span class="heading-font-family flex-1 text-center fw-400">Bildirimler</span>
                        </header>
                        <ul class="card-body list-unstyled dropdown-list-group">
                            @if(count(\App\Models\Reminder::FaturaHatırlatıcı())!==0)
                                @foreach(\App\Models\Reminder::FaturaHatırlatıcı() as $k => $v)
                                    <li>
                                        <a href="{{$v['uri']}}" class="media">

                                                <span class="media-body"><span class="heading-font-family media-heading">{{$v['name']}}</span>
                                                    <span class="media-content">{{\App\Models\Müsteriler::getPublicName($v['musteriId'])}} - {{$v['fiyat']}} Tl</span>
                                                    <span class="user--online float-right my-auto">
                                                    </span>
                                                </span>
                                        </a>
                                    </li>
                ...
                <div class="col-sm-12 text-center p-0 clearfix">
                    <div class="d-inline-block pos-relative mr-b-10">
                        <figure class="thumb-sm mr-b-0 user--online">
                            <img src="{{asset(asset(\App\Models\User::getPhoto()))}}" class="rounded-circle" alt="">
