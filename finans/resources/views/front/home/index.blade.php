...
@section('content')
    ...
    <div class="widget-list row">
        ...
        <div class="widget-holder widget-sm widget-border-radius col-md-3">
            <div class="widget-bg">
                <div class="widget-heading bg-purple"><span class="widget-title my-0 color-white fs-12 fw-600">Toplam Tahsilat Faturası</span>
                </div>
                <!-- /.widget-heading -->
                <div class="widget-body">
                    <div class="counter-w-info">
                ...
                <div class="widget-body">
                    <table class="widget-latest-transactions">
                        ...
                        <tr>
                            ...
                            <td class="single-user-details"><a class="single-user-name" href="#">{{$v['text']}}</a>
