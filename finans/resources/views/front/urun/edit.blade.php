            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{route('urun.update',['id'=>$data[0]['id']])}}" enctype="multipart/form-data" method="POST" >
                            @csrf

                            <div class="form-group row firma--area">
                                <div class="col-md-12">
                                    <label class="col-form-label" for="10">Ürün Adı</label>
                                    <input class="form-control" required name="urunAdi" placeholder="Ürün Adınızı Girin" type="text" value="{{$data[0]['urunAdi']}}">
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="kalemId"  class="m-b-10 form-control" data-placeholder="Kalem Seçiniz" data-toggle="select2">
                                            ...
                                            @foreach(\App\Models\Kalem::all() as $key=>$value)
                                                <option @if($value['id']==$data[0]['kalemId']) selected @endif value="{{$value['id']}}">{{$value['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" required name="alisFiyati" placeholder="Ürün Adınızı Girin" type="text" value="{{$data[0]['alisFiyati']}}">

                                </div>
                                <div class="col-md-6">
                                    <label for="" class="col-form-label">Satış Fiyatı</label>
                                    <input class="form-control" required name="satisFiyati" placeholder="Ürün Adınızı Girin" type="text" value="{{$data[0]['satisFiyati']}}">
                                </div>
                            </div>
