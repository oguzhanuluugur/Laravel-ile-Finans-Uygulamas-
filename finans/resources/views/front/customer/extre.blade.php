                       ...
                       <div class="widget-user-profile">
                           ...
                           <div class="profile-body">
                               <figure class="profile-user-avatar thumb-md">
                                   <img src="{{asset(\App\Models\Müsteriler::getPhoto($data[0]['id']))}}" alt="User Wall">
                               </figure>
                               <h6 class="h3 profile-user-name">{{\App\Models\Müsteriler::getPublicName($data[0]['id'])}}</h6>
                               <small class="profile-user-address">@if($data[0]['müsteriTipi']==0) Bireysel @else Kurumsal @endif</small>
                               <hr class="profile-seperator">

                               <!-- /.profile-user-description -->
                               <div class="mb-5">
                                   <a href="{{route('customer.edit',['id'=>$data[0]['id']])}}" class="btn btn-outline-color-scheme btn-rounded btn-lg px-5 border-thick text-uppercase mr-2 mr-0-rtl ml-2-rtl fw-700 fs-11 heading-font-family">Düzenle</a>
                               </div>
                           </div>
                           <div class="row">
