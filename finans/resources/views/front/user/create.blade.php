            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{route('user.store')}}" autocomplete="off" enctype="multipart/form-data" method="POST" >
                            @csrf
                            <div class="form-group row ">
                                <div class="col-md-12">
                                    <label class="col-form-label" for="10">Kullanıcı Adı</label>
                                    <input class="form-control" required name="name" placeholder="Kullanıcı Adınızı Girin" type="text">
                                </div>
                                <div class="col-md-12">
                                    <label class="col-form-label" for="10">Kullanıcı Email</label>
                                    <input class="form-control" required name="email" placeholder="Emailinizi  Girin" type="email">
                                </div>
                                <div class="col-md-12">
                                    <label class="col-form-label" for="10">Kullanıcı Şifre</label>
                                    <input class="form-control" required name="password" placeholder="Şifrenizi Adınızı Girin" type="password">
                                </div>
                            </div>
                            <div class="row">
