            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <h5 class="box-title mr-b-0">Yeni Teklif Ekle</h5>

                        <form action="{{route('teklif.store')}}" enctype="multipart/form-data" method="POST" >
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" required name="fiyat" placeholder="Teklif Fiyatı Giriniz" type="text">
                                </div>
                            ...
                            <div class="form-group">
                                <button type="button"class="btn btn-primary" id="add-product">Ürün Ekle</button>
