            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{route('fatura.store',['type'=>0])}}" enctype="multipart/form-data" method="POST" >
                            @csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="musteriId"  class="m-b-10 form-control" data-placeholder="Choose" data-toggle="select2">
                                      @foreach(\App\Models\Müsteriler::all() as $key=>$value)
                                        <option value="{{$value['id']}}">{{\App\Models\Müsteriler::getPublicName($value['id'])}}</option>
                                      @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        ...
        $("#addRowBtn").click(function (){
          var newRow =
            ...
            @endforeach
                newRow+='</select></td>'+
                      '<td><input type="text" class="form-control"id="gün_adet" name="islem['+i+'][gün_adet]"></td>'+
