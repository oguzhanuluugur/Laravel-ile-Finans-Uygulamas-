            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{route('banka.update',['id'=>$data[0]['id']])}}" enctype="multipart/form-data" method="POST" >
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" required name="name" placeholder="Banka Adı Girin" type="text" value="{{$data[0]['name']}}">
                                </div>

                                <div class="col-md-4">
                                    <label class="col-form-label" for="10">Banka Iban</label>
                                    <input class="form-control" required  name="iban"  placeholder="TR0000000000000000000000" type="text"value="{{$data[0]['iban']}}">
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="10">Banka Hesap No</label>
                                    <input class="form-control" required  name="hesapNo"  placeholder="Hesap No" type="text"value="{{$data[0]['hesapNo']}}">
                                </div>
                            </div>
