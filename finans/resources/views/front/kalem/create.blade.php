            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <h5 class="box-title mr-b-0">Yeni Kalem Ekle</h5>

                        <form action="{{route('kalem.store')}}" enctype="multipart/form-data" method="POST" >
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" required name="name" placeholder="Kalem Adınızı Girin" type="text">
                                </div>

                                <div class="col-md-6">
                                    <label class="col-form-label" for="10">KDV</label>
                                    <input class="form-control" required value="18" name="kdv"  placeholder="Kdv" type="text">
                                </div>
                            </div>
